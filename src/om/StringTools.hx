...
class StringTools {
	public static inline function contains(s:String, value:String):Bool
		return std.StringTools.contains(s, value);

	public static inline function htmlEscape(s:String, ?quotes:Bool):String
		return std.StringTools.htmlEscape(s, quotes);

	public static inline function htmlUnescape(s:String):String
		return std.StringTools.htmlUnescape(s);
	...
	public static inline function lpad(s:String, c:String, l:Int):String
		return std.StringTools.lpad(s, c, l);

	public static inline function rpad(s:String, c:String, l:Int):String
		return std.StringTools.rpad(s, c, l);

	public static inline function replace(s:String, sub:String, by:String):String
		return std.StringTools.replace(s, sub, by);

	public static inline function hex(n:Int, ?digits:Int):String
		return std.StringTools.hex(n, digits);

	public static inline function fastCodeAt(s:String, index:Int):Int
		return std.StringTools.fastCodeAt(s, index);

	public static inline function isEof(c:Int):Bool
		return std.StringTools.isEof(c);

	public static inline function quoteUnixArg(argument:String):String
		return haxe.SysTools.quoteUnixArg(argument);

	public static inline function quoteWinArg(argument:String, escapeMetaCharacters:Bool):String
	...
	public static function quote(str:String):String {
		return if (str.indexOf('"') < 0) '"' + str + '"'; else if (str.indexOf("'") < 0) "'" + str + "'"; else '"' + StringTools.replace(str, '"', '\\"') + '"';
	}
	...
	//	var str = "";
	//	for (i in 0...length)
	//		str += charset.charAt(values[i] % charset.length);
	//	return str;
	//	#else
	//	#error
	//	#end
